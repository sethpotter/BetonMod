...
public class BetonConfig implements ConfigData {
    ...
    public final SimpleOption<Double> airControl = intRangeSlider("Air Control", 7.5, 0.0, 20.0, 0, 2000, 100.0);
    public final SimpleOption<Double> groundControl = intRangeSlider("Ground Control", 7.0, 0.0, 20.0, 0, 2000, 100.0);
    public final SimpleOption<Double> lowFrictionControl = intRangeSlider("Low Friction Control", 1.0, 0.0, 20.0, 0, 2000, 100.0);
    public final SimpleOption<Double> airSpeedBonus = intRangeSlider("Air Speed Bonus", 0.20, -10.0, 10.0, -500, 500, 500.0);
    ...
    public final SimpleOption<Double> slideBoostDecay = intRangeSlider("Slide Boost Decay", 0.80, 0.0, 10.0, 0, 1000, 100.0);
    ...
    public final SimpleOption<Double> sprintingSpeed = intRangeSlider("Sprinting Speed", 0.05, 0.0, 2.0, 0, 200, 100.0);
